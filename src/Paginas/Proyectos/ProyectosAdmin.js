                ...
                <tbody>
                  {productos.map((producto) => (
                    <tr key={producto.id}>
                      ...
                      <td>
                      <Link to={`/produtos/editar/${producto.id}@${producto.nombre}@${producto.precio}@${producto.categoria}@${producto.region}@${producto.direccionEnvio}@${producto.ciudadEnvio}`} 
                        ...
                        <Link to={`/produtos/envios/${producto.id}@${producto.nombre}@${producto.precio}@${producto.categoria}@${producto.region}@`} 
                        className="btn btn-sm btn-warning">Envios</Link>&nbsp;&nbsp;
                      </td>
